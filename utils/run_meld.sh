...
run_experiment() {
    ...
    echo -e "${BLUE}Clients: audio=${audio_clients}, text=${text_clients}, both=${both_clients}${NC}"
    echo -e "${BLUE}========================================${NC}"
    ...
    CMD="${BASE_CMD} \
        ...
        experiment.clients.text=${text_clients} \
        experiment.clients.audio_text=${both_clients}"
