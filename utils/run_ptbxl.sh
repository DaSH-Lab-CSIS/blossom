...
run_experiment() {
    local partitioner=$1
    local aggregation=$2
    local iToAvf_clients=$3
    local v1ToV6_clients=$4
    ...
    echo -e "${BLUE}Clients: iToAvf=${iToAvf_clients}, v1ToV6=${v1ToV6_clients}, both=${both_clients}${NC}"
    echo -e "${BLUE}========================================${NC}"
    ...
    CMD="${BASE_CMD} \
        ...
        experiment.clients.iToAvf=${iToAvf_clients} \
        experiment.clients.v1ToV6=${v1ToV6_clients} \
        experiment.clients.iToAvf_v1ToV6=${both_clients}"
